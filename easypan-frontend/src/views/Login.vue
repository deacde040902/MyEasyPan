      ...
      <div class="login-card">
        ...
        >
          ...
          <div class="form-extra">
            ...
            <span class="forgot-pwd" @click="goForgetPassword">忘记密码?</span>
          </div>
          ...
          <div class="login-actions">
            ...
            <el-button type="warning" class="action-btn" @click="goToAdminLogin">
              管理员登录
            </el-button>
            <el-button type="success" class="action-btn" @click="goToShare">
              分享中心
            </el-button>
          </div>
          ...
          <el-button class="qq-login-btn">QQ快捷登录</el-button>
...
const handleLogin = async () => {
  try {
    ...
    // 🔥 关键修复：字段名必须和后端 LoginDTO 完全一致！
    const params: LoginParams = {
      email: loginForm.email,
      password: loginForm.password,
      checkCode: loginForm.code,          // 前端 code → 后端 checkCode
      checkCodeKey: checkCodeKey.value    // 验证码唯一标识
    }

    const res = await checkCodeLogin(params)
